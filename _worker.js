...
// Variables
const rootDomain = "arshaka.biz.id"; // Ganti dengan domain utama kalian
const serviceName = "server"; // Ganti dengan nama workers kalian
const apiKey = "ovkJvQK9a4n9RcIOGLswuMBhYp0g2x6apv_KQw4w"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "alfariel749@gmail.com"; // Ganti dengan email yang kalian gunakan
